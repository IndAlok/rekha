...
export default function WebhooksPage() {
  ...
  return (
    <>
      <PageHeader title="Webhook console" lede="HMAC is skipped only in dev when the secret is unset. Every request is deduped on the event id." />
      ...
      <div className="cols">
        ...
        >
          ...
          <Field label="X-Razorpay-Signature (optional)">
            <input className="input mono" value={signature} onChange={(e) => setSignature(e.target.value)} placeholder="required outside dev" />
          </Field>
          <textarea className="textarea" aria-label="Webhook JSON body" value={body} onChange={(e) => setBody(e.target.value)} rows={16} style={{ marginTop: 10, minHeight: 320 }} />
